...
static BROKENITHM_STR_FILES: phf::Map<&'static str, (&'static str, &'static str)> = phf_map! {
  ...
  "lib/control_utils/control_utils.css" => (include_str!("./brokenithm-www/handtracker/lib/control_utils/control_utils.css"), "text/css"),
  "mediapipe-hand-src.js" => (include_str!("./brokenithm-www/handtracker/mediapipe-hand-src.js"), "text/javascript"),
  "lib/camera_utils/camera_utils.js" => (include_str!("./brokenithm-www/handtracker/lib/camera_utils/camera_utils.js"), "text/javascript"),
  "lib/control_utils/control_utils.js" => (include_str!("./brokenithm-www/handtracker/lib/control_utils/control_utils.js"), "text/javascript"),
